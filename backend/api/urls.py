...
urlpatterns = [
    ...
    path("api/dashboard/borrow-trend", views.dashboard_borrow_trend),
    ...
    path("api/members/<str:member_uid>/delete", views.member_delete),
    path("api/members/<str:member_uid>", views.member_update),
