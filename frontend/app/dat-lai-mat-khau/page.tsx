        ...
        <main className="flex flex-col min-h-[calc(100vh-56px)]">
          <div className="flex-1 overflow-y-auto scroll-smooth bg-white no-scrollbar flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-md text-center">
              ...
              <Link href="/quen-mat-khau" className="text-[#137fec] hover:underline font-medium">
                ...
                <label className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="h-12 w-full rounded-lg border border-slate-200 bg-slate-50 pl-4 pr-12 text-sm text-slate-900 placeholder-slate-400 focus:border-[#137fec] focus:outline-none focus:ring-1 focus:ring-[#137fec]"
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-[#137fec]"
                    >
