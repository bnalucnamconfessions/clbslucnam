...
export default function CaiDatWebsitePage() {
          ...
          <div className="flex-1 overflow-y-auto scroll-smooth bg-white no-scrollbar">
            <header className="px-4 md:px-6 lg:px-8 pt-6 pb-6 border-b border-slate-200 bg-white">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-slate-500 text-base font-normal leading-normal">
                  Chỉ Ban chủ nhiệm có quyền chỉnh sửa tên website, logo, liên hệ và chân trang.
                </p>
              </div>
            </header>
            <div className="px-4 md:px-6 lg:px-8 py-6 w-full">
              <div className="flex items-center gap-2 mb-6 border-b border-slate-200 pb-2">
                ...
                <Link
                  href="/dashboard/cai-dat/quy-tac-muon"
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#137fec] focus:border-[#137fec] outline-none"
                      placeholder="VD: CLB Sách và Hành động THPT Lục Nam"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#137fec] focus:border-[#137fec] outline-none resize-y"
                      placeholder="Văn bản hiển thị ở chân trang"
                    />
                  </div>
                  <div className="pt-2">
                    <button
