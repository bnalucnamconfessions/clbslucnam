...
/** Cài đặt website: quyền chỉnh sửa cấu hình website — chỉ Ban chủ nhiệm. */
export const CAI_DAT_CAN_EDIT: readonly string[] = BAN_CHU_NHIEM

export function canEditCaiDat(permission: string): boolean {
  return CAI_DAT_CAN_EDIT.includes(normalizePermission(permission))
}
